...
public class FrameworkInitialize extends Base {
    ...
    public static void InitializeBrowser(BrowserType browserType) throws MalformedURLException {
        ...
        switch (browserType)
        {
            case Chrome:
            {
                System.setProperty("webdriver.chrome.driver", "/Users/gsanchez/Documents/original/drivers/chromedriver");
            ...
            {
                //Open the browser
                System.setProperty("webdriver.gecko.driver", "/Users/gsanchez/Documents/original/drivers/geckodriver");
